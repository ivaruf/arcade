...
for tag in ['Welcome','Race','Water','Mine','Calm','Dam']:assert tag+' sculpted cloud' in names
...
print(f'Checked {len(d["meshes"])} meshes; six islands, six fish, embedded resources, transparent glazing and finite positions. {len(b)/1048576:.1f} MiB.')
